...
const PersonnelTab: FC<PersonnelTabProps> = ({ collectionName, title }) => {
  ...
  const handleAddPersonnel = async (values: z.infer<typeof personnelSchema>) => {
    ...
    const result = await addPersonnelAction(collectionName, values, currentUser.email);
  ...
  const handleEditPersonnel = async (values: z.infer<typeof personnelSchema>) => {
    ...
    const result = await updatePersonnelAction(collectionName, editingPersonnel.id, values, currentUser.email);
  ...
  const handleDeletePersonnel = async (id: string) => {
    ...
    const result = await deletePersonnelAction(collectionName, id, currentUser.email);
