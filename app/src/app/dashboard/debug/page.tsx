        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    ...
                    Estes valores vêm do seu arquivo `.env` ou das configurações do seu ambiente de hospedagem.
                </CardDescription>
            </CardHeader>
                ...
                <div className="flex justify-between items-center border p-4 rounded-md">
                 ...
                 {!projectId || !clientEmail || !privateKeyExists ? (
                    ...
                    <div className="p-4 bg-green-600/10 border-l-4 border-green-600 text-green-800 dark:text-green-300 rounded-md">
                        ...
                        <p>Todas as variáveis de ambiente necessárias para o Firebase Admin SDK parecem estar definidas. Se o erro de inicialização persistir, o problema pode estar no conteúdo das variáveis (ex: chave privada mal formatada).</p>
                    </div>
                )}
